...
**Snake game**
* 📝 Description: This project a classic snake game that can be played with the arrow keys on keyboard. The snake is shown in green and the food is shown in red.
